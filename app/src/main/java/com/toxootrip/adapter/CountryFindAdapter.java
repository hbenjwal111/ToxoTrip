...
public class CountryFindAdapter extends RecyclerView.Adapter<CountryFindAdapter.MyViewHolder> implements Filterable {
    ...
    public CountryFindAdapter(Context context,List<InternationalModel> list) {
    ...
    public void onBindViewHolder(MyViewHolder holder,final int position) {
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent commonActivity = new Intent(context, HomeActivity.class);

                  country_name = filterList.get(position).getCountry_name();
                  mApp.saveNameCountry(context,country_name);

                ((Activity)context).setResult(4, commonActivity);
