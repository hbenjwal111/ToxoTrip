...
public class SearchProductAdapter extends RecyclerView.Adapter<SearchProductAdapter.MyViewHolder>  {
    ...
    public List<SearchProductModel> allProductModelList;
    ...
    public SearchProductAdapter(Context context, List<SearchProductModel> allProductModelList) {
    ...
    public void onBindViewHolder(SearchProductAdapter.MyViewHolder holder, int position) {
        ...
        final SearchProductModel constant = allProductModelList.get(position);
