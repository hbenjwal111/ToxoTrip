...
public class InternationCountryAdapter extends RecyclerView.Adapter<InternationCountryAdapter.MyViewHolder> implements Filterable {
    ...
    public InternationCountryAdapter(Context context,List<InternationalModel> list) {
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              //  InternationalModel constant
                ...
                commonActivity.putExtra("flowType", CommonBaseActivity.SEARCH);

                commonActivity.putExtra("country_id", filterList.get(position).getCountry_id()+"");
