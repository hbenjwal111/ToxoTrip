...
import com.toxootrip.adapter.TypeAdapter;
...
public class SubCategoryFragment extends BaseFragment {
    ...
    private ArrayList<TypeModel> modelArrayList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_sub, parent, false);
        ...
        recyclerView.addOnItemTouchListener(new SearchFragment.RecyclerTouchListener(getActivity(), recyclerView, new SearchFragment.ClickListener() {
            ...
            public void onClick(View view, int position) {
                TypeModel selecteditemPosition = modelArrayList.get(position);
                Intent commonActivity = new Intent(getActivity(), CommonBaseActivity.class);
                commonActivity.putExtra("flowType",CommonBaseActivity.UPLOADPRODUCT);
                commonActivity.putExtra("type_id",selecteditemPosition.getType_id()+"");
                ...
                commonActivity.putExtra("type_name",selecteditemPosition.getType_name());
    ...
    private void getAllCity(){
       ...
       /* try {
        ...
        mAPIService.getAllType(category_id).enqueue(new Callback<TypeList>() {

            @Override
            public void onResponse(Call<TypeList> call, retrofit2.Response<TypeList> response) {
                TypeList hotelList = response.body();
                if (hotelList.getStatus() == 1) {
                    modelArrayList= hotelList.getTypeModels();
                    mAdapter = new TypeAdapter(getActivity(), modelArrayList);
