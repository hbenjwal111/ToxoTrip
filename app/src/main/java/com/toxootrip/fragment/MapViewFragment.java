...
public class MapViewFragment extends SupportMapFragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
                                ...
                                if (hotelList.getStatus() == 1) {
                                        if(!(mMap == null)) {
                                                for(int i = 0;i<hotelList.getHotelModelList().size();i++) {
                                                        ...
                                                        mMap.addMarker(new MarkerOptions().position(location).title(hotelList.getHotelModelList()
                                                                .get(i).getHotel_name()));
