...
import com.toxootrip.adapter.InternationCountryAdapter;
...
public class InternationalFragment extends BaseFragment {
    ...
    private InternationCountryAdapter searchAdapter;
        ...
        mAPIService.getAllCountry(country_name).enqueue(new Callback<InternationList>() {
            ...
            public void onResponse(Call<InternationList> call, Response<InternationList> response) {
                ...
                if(searchList.getStatus()==1){
                    ...
                    ;
                    searchAdapter = new InternationCountryAdapter(getActivity(),modelArrayList);
