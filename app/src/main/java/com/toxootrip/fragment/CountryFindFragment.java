...
import com.toxootrip.adapter.CountryFindAdapter;
...
public class CountryFindFragment  extends BaseFragment{
    private List<InternationalModel> modelArrayList;
    private RecyclerView recyclerView;
    private CountryFindAdapter searchAdapter;
        ...
        mAPIService.getAllCountry(country_name).enqueue(new Callback<InternationList>() {
            ...
            public void onResponse(Call<InternationList> call, Response<InternationList> response) {
                ...
                if(searchList.getStatus()==1){
                    ...
                    ;
                    searchAdapter = new CountryFindAdapter(getActivity(),modelArrayList);
